var nums = [1, 2, 3, 4, 5];
var items = ["Coke", "Kit Kat", "Bar One", "Fanta", "Lunch Bar"];
var prices = [7.5, 9.5, 8.5, 7.5, 10];
...
function checkout() {
    document.getElementById("checkoutTotal").innerHTML = "Total R: " + totalOrderAmt.toFixed(2);
}
